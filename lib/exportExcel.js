...
// Free-text fields (transaction names) land verbatim in spreadsheet cells.
// A name starting with =, +, -, @ etc. would otherwise become a live formula
// when the exported file is opened — prefix with an apostrophe to force
// Excel/Sheets to treat it as plain text instead.
